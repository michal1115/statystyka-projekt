...
```{r}
sex_outcome <- data_raw %>% select(sex) # zbiór, który będziemy przewidywać
data_classification_without_sex <- data_classification %>% select(-sex) # usuwamy kolumnę, którą będziemy przewidywać
set.seed(1234) 
